...
export default function Docs() {
	...
	return (
		<Container style=" text-neutral-900 mt-[100px] flex justify-center relative">
			<div className="w-[80%] flex gap-x-1 items-left justify-between mb-44 p-4 relative">
				<div className="w-[20%] h-full flex flex-col gap-4 text-sm sticky top-0">
				...
				<div className="border-l w-[80%] pl-12 h-full flex flex-col gap-14">
					...
					<div className="flex flex-col gap-2">
						...
						<div className=" border-gray-700 flex flex-col">
							<span className={``}>
								...
								<span className="bg-gray-100 rounded text-sm p-1 font-medium">Create New Project</span>:
							</span>
					...
					<div className="flex flex-col gap-2">
						...
						<div className=" border-gray-700 flex flex-col">
							...
							<span className="mt-6">
								If you already have a project, click <span className="bg-gray-100  font-medium rounded text-sm p-1">Upload</span> in the project
					...
					<div className="flex flex-col gap-2">
						...
						<div className=" border-gray-700 flex flex-col">
							<span className={``}>
								To create a dataset version, click <span className="bg-gray-100  font-medium rounded text-sm p-1">Versions</span> in the sidebar
								associated with your Roboflow project. Then, click{' '}
								<span className="bg-gray-100  font-medium rounded text-sm p-1">Generate New Version</span>. From this page, you can set a
								train/test/valid split and specify preprocessing steps and augmentations for your new dataset version.
							</span>
							<span className="mt-4">
								Once you have specified the preprocessing steps and augmentations you want to apply to your data, click{' '}
								<span className="bg-gray-100  font-medium rounded text-sm p-1">Generate</span>. This will generate a new dataset version. You can then
								use this dataset version to train a model in Roboflow. You can also export your dataset for use in training a model manually.
							</span>
						</div>
					</div>
					<div className="flex flex-col gap-2">
						...
						<div className=" border-gray-700 flex flex-col">
							<span className={``}>
								To access this dataset, click <span className="bg-gray-100  font-medium rounded text-sm p-1">Versions</span> in the sidebar associated
								with your Roboflow project. Then select the dataset version that you want to export and click Export Dataset.
							</span>
							<span className="mt-4">
								From this page, you can select which format this dataset will be used and select{' '}
								<span className="bg-gray-100  font-medium rounded text-sm p-1">show download code</span> to get your API key, and other details,
								otherwise, you can also download the dataset via zip file.
							</span>
						</div>
					</div>
					<div className="flex flex-col gap-2">
					...
					<div className="flex flex-col gap-2">
						...
						<div className=" border-gray-700 flex flex-col">
							...
							<ul className="list-disc pl-10">
								<li>
									<b>Single-click</b> an existing bounding box to select it. Once selected, you can change a bounding boxs size with the circular
									white handles that appear on its corners and on each side. Or use the class editor to change the boxs label.
								</li>
								<li>
						...
						<div className=" border-gray-700 flex flex-col">
							...
							<ul className="list-disc pl-10">
								...
								<li>
									...
									purple) and, sometimes, a <span className="bg-gray-100  font-medium rounded text-sm p-1">&quote;Create class&quote;</span> option if
									the text you typed does not match an existing class.
								</li>
							</ul>
						</div>
					</div>
